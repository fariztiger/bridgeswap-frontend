...
import { Flex, Text, Skeleton } from '@vanshtah/bridgeswap-uikit'
...
const FarmCard: React.FC<FarmCardProps> = ({ farm, removed, cakePrice, account }) => {
  ...
  const lpLabel = farm.lpSymbol && farm.lpSymbol.toUpperCase().replace('BridgeSwap', '')
  ...
  return (
    <FCard>
      {farm.token.symbol === 'BRIS' && <StyledCardAccent />}
      <CardHeading
        lpLabel={lpLabel}
